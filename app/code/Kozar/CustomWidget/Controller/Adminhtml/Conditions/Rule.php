...
namespace Kozar\CustomWidget\Controller\Adminhtml\Conditions;
...
abstract class Rule extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $this->_setActiveMenu('Kozar_CustomWidget::universal')
    ...
    {
        return $this->_authorization->isAllowed('Kozar_CustomWidget::rules');
    }
}
